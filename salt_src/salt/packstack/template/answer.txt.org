...
# Cinder.
CONFIG_STORAGE_HOST=172.16.70.197

# (Unsupported!) The IP address of the server on which to install
# OpenStack services specific to Sahara
CONFIG_SAHARA_HOST=172.16.70.197
...
CONFIG_AMQP_HOST=172.16.70.197
...
CONFIG_MARIADB_HOST=172.16.70.197

# Username for the MariaDB admin user
CONFIG_MARIADB_USER=root

# Password for the MariaDB admin user
CONFIG_MARIADB_PW=ab0a8b32a3c7432e

# The password to use for the Keystone to access DB
CONFIG_KEYSTONE_DB_PW=65fa83f0775149a9

# Region name
CONFIG_KEYSTONE_REGION=RegionOne

# The token to use for the Keystone service api
CONFIG_KEYSTONE_ADMIN_TOKEN=60546f44fa0a403c8e8b5f38cd8adee3

# The password to use for the Keystone admin user
CONFIG_KEYSTONE_ADMIN_PW=c2ed765633f64fb2

# The password to use for the Keystone demo user
CONFIG_KEYSTONE_DEMO_PW=1438149b3f514a7f
...
CONFIG_KEYSTONE_LDAP_URL=ldap://172.16.70.197
...
CONFIG_GLANCE_DB_PW=ba91779316e742a1

# The password to use for the Glance to authenticate with Keystone
CONFIG_GLANCE_KS_PW=1d13f57f5ee24acb
...
CONFIG_CINDER_DB_PW=0f255681287e43cb

# The password to use for the Cinder to authenticate with Keystone
CONFIG_CINDER_KS_PW=013f8a97db6e499e
...
CONFIG_NOVA_DB_PW=9e25e9a9ed9c47c8

# The password to use for the Nova to authenticate with Keystone
CONFIG_NOVA_KS_PW=2c9b3175a1e64caa
...
CONFIG_NEUTRON_KS_PW=d8897665964a4afa

# The password to use for Neutron to access DB
CONFIG_NEUTRON_DB_PW=060c9c5120d7499b
...
CONFIG_NEUTRON_METADATA_PW=333e33e31a96462b
...
CONFIG_SWIFT_KS_PW=9a2f2a53257449cd
...
CONFIG_SWIFT_HASH=674e0d91c25d4c9c
...
# 24, or 32 chars)
CONFIG_HEAT_AUTH_ENC_KEY=c50474e6c8d042bb
...
CONFIG_NAGIOS_PW=354063ab10734d60
